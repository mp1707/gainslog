...
export const createStyles = (colors: any) =>
  StyleSheet.create({
    ...
    semanticCalories: {
      backgroundColor:
        colors.semanticBadges?.calories?.background || "rgba(98, 0, 234, 0.15)",
    },

    semanticProtein: {
      backgroundColor:
        colors.semanticBadges?.protein?.background ||
        "rgba(20, 184, 166, 0.15)",
    },

    semanticCarbs: {
      backgroundColor:
        colors.semanticBadges?.carbs?.background || "rgba(59, 130, 246, 0.15)",
    },

    semanticFat: {
      backgroundColor:
        colors.semanticBadges?.fat?.background || "rgba(245, 158, 11, 0.15)",
    },
    ...
    semanticProteinText: {
      color:
        colors.semanticBadges?.protein?.text ||
    ...
    semanticCarbsText: {
      color:
        colors.semanticBadges?.carbs?.text ||
    ...
    semanticFatText: {
      color:
        colors.semanticBadges?.fat?.text || colors.semantic?.fat || "#F59E0B",
    },
